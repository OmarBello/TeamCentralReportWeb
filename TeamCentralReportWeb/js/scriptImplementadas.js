$(document).ready(function() {
    $.getJSON("https://172.17.50.98:8080/api/Recomendaciones/Implementadas",function(data) {
        console.log(data);
        var items = [];
        ...
        $.each(items, function(key, value) {
            ...
            employee_data += '<td>' + value.fecha_Notificacion + '</td>';
            employee_data += '<td>' + value.dias_Transcurridos + '</td>';
