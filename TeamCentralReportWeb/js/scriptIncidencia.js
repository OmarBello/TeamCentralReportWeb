...
function TraerData() {
    ...
    $.getJSON({
        url: 'https://172.17.50.98:443/api/Recomendaciones/GetAllIncidenciaVencerPorVencer?entidad='+entidad+
        '&estatus='+estatus,
        type: 'GET',
    ...
    $.getJSON({
        url: 'https://172.17.50.98:443/api/Recomendaciones/GetAllIncidencia?entidad='+entidad+
        '&estatus='+estatus,
        type: 'GET',
